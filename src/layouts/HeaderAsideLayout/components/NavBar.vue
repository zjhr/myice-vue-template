<template>
  <el-menu class="navbar" mode="horizontal">
		<li @click="$emit('SideBarClose')" class="m-pa-lt z-txtcen s_middle z-tran3" style="width: 45px;height: 65px;">
			<my-icon name="bars" scale="1.5" flip="horizontal" class="s_middle_child"></my-icon>
		</li>
    <li class="user-profile-container" trigger="click">
